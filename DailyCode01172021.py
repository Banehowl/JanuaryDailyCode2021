# -----------------------------------------------------
#	Daily Code	01/17/2021
#   "Regular Expressions" Lesson from learnpython.org
#   Coded by: Banehowl
# -----------------------------------------------------
...
# complex, so when contemplating using a regex for a certain task, think about alternatives, and come to regexes as a
# last resort.
...
# The following group, the part with (From|To|Cc) means that the line has to start with one of
# the words that are separated by the pipe |. That is called the OR operator, and the regex will match if the line
