# ----------------------------------------------------
#	Daily Code	01/24/2021
#   "Closures" Lesson from learnpython.org
#   Coded by: Banehowl
# ----------------------------------------------------
...
# This works well as the 'data_transmitter' function can access the 'message'. To demonstrate the use of the
# "nonlocal" keyword, consider this:
...
# Exercise: Make a nested loop and a python closure to make functions to get multiple multiplication functions
# using closures. That is using closures, one could make functions to create multiply_with_5() or multiply_with_4()
